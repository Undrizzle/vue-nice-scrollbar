...
/***/ function(module, exports, __webpack_require__) {
	...
	var _vueNiceScrollbar = __webpack_require__(8);

	var _vueNiceScrollbar2 = _interopRequireDefault(_vueNiceScrollbar);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	exports.default = {
	    components: { vueNiceScrollbar: _vueNiceScrollbar2.default }
	};
	// </script>
	//
	// <style lang="less">
	...
	// <template>
	//     <div id="app">
	//         <h1>vue-nice-scrollbar</h1>
	//         <vue-nice-scrollbar classes="my-scrollbar" theme="dark" v-bind:speed=53>
	//             <div class="scroll-me">
	//                 <div class="kolom"></div>
	//                 <div class="kolom"></div>
	//                 <div class="kolom"></div>
	...
	exports.default = {
	    ...
	    methods: {
	        calculateSize: function calculateSize() {
	            ...
	            alert(this.scrollContentHeight);
	...
	exports.default = {
	    ...
	    methods: {
	        ...
	        jump: function jump(e) {
	            var isRailY = e.target === this.$refs.scrollRailY;
	            if (isRailY) {
	                var position = this.$refs.scrollSliderY.getBoundingClientRect();
